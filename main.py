...
def main():
    ...
    if hps.test_split != '':
        ...
        print("DEBUG - Dataset root:", hps.dataset_root)
        print("DEBUG - Splits dir:", hps.splits_dir) 
        print("DEBUG - Test split:", hps.test_split)
        print("DEBUG - Split files found:", split_files)
